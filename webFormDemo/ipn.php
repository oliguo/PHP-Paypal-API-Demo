...
mmmail('testing@abc.com', 'testing','<p><b>123</b></p>');
...
if ($verified) {
    ...
    */
    mmmail('testing@abc.com', 'Verified IPN', $listener->getTextReport());
    ...
    invalid IPN.
    */
    mmmail('testing@abc.com', 'Invalid IPN', $listener->getTextReport());
}
    
function mmmail($to,$subject,$message){
        $headers = 'From: testing@tee.com' . "\r\n" .
